...
const dictionary: Dictionary = {
  ...
  addDonation: { en: "Add Donation", sw: "Ongeza Mchango" },
  ...
  givingRecords: { en: "Giving Records", sw: "Rekodi za Michango" },
  ...
  donationsSubtitle: {
    en: "Record tithes, offerings, and giving history with secure access.",
    sw: "Rekodi zaka, sadaka, na historia ya michango kwa usalama.",
  },
  attendanceSubtitle: {
  ...
  totalGiving: { en: "Total Giving", sw: "Jumla ya Michango" },
  upcomingEvents: { en: "Upcoming Events", sw: "Matukio Yanayokuja" },
  recordedDonations: { en: "Recorded donations", sw: "Michango iliyorekodiwa" },
  ...
  nextStepsBody: {
    en: "Use the sidebar to manage members, attendance, events, sermons, and donations. Reports and exports are ready for admin review.",
    sw: "Tumia upau wa pembeni kusimamia washiriki, mahudhurio, matukio, mahubiri, na michango. Ripoti na usafirishaji ziko tayari kwa ukaguzi wa msimamizi.",
  },
  loginHeadline: {
  ...
  loginSubtitle: {
    en: "Secure access for leadership, staff, and members with centralized management for giving, attendance, and events.",
    sw: "Ufikiaji salama kwa viongozi, wafanyakazi, na washiriki kwa usimamizi wa michango, mahudhurio, na matukio.",
  },
  loginFeatureOne: {
    en: "Track membership, giving, and attendance in one place.",
    sw: "Fuatilia uanachama, michango, na mahudhurio sehemu moja.",
  },
  loginFeatureTwo: {
  ...
  recordDonation: { en: "Record new donation", sw: "Rekodi mchango mpya" },
  ...
  reportsDonations: { en: "Giving records export.", sw: "Usafirishaji wa rekodi za michango." },
